...
// Not used right now
void DialogKernel::processOutput()
{
...
void DialogKernel::processFinished(int exitCode)
{
    QProcess *p = dynamic_cast<QProcess *>( sender() );
...
void DialogKernel::on_flashButton_clicked()
{
...
void DialogKernel::closeEvent(QCloseEvent *event)
{
